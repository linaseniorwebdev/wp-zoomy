...
<div class="theme_option_field cf">
	...
	<div class="theme_option_input">
		...
		<ul>
			...
			<li><label><input name="dp_options[show_google_top]" type="checkbox" value="1" <?php checked( 1, $dp_options['show_google_top'] ); ?>><?php _e( 'Display google+ button', 'tcd-w' ); ?></label></li>
		...
		<?php foreach ( $sns_type_top_options as $option ) : ?>
			<label>
				<input type="radio" name="dp_options[sns_type_btm]" value="<?php echo esc_attr( $option['value'] ); ?>" <?php checked( $option['value'], $dp_options['sns_type_top'] ); ?>>
				<?php echo $option['label']; ?>
				<img src="<?php echo esc_attr( $option['image'] ); ?>" alt="<?php echo esc_attr( $option['label'] ); ?>">
			</label>
		<?php endforeach; ?>
		...
		<ul>
			...
			<li><label><input name="dp_options[show_google_btm]" type="checkbox" value="1" <?php checked( 1, $dp_options['show_google_btm'] ); ?>><?php _e( 'Display google+ button', 'tcd-w' ); ?></label></li>
